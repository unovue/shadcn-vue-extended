...
<template>
  <NuxtLink
    ...
    target="_blank"
    class="not-prose inline-flex items-center gap-1 rounded-full bg-accent pr-2.5 text-xs font-mono font-semibold text-muted-foreground hover:text-accent-foreground translate-y-[7px] mx-1"
  >
