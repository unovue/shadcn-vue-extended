...
<template>
  ...
  >
    <Label
      ...
      :class="
        cn(
          'text-xs text-muted-foreground bg-transparent backdrop-blur-3xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-center items-center',
